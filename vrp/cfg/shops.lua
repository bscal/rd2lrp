...
cfg.shop_types = {
  ...
  ["drugstore"] = {
    _config = {map_entity = {"PoI", {blip_id = 51, blip_color = 2, marker_id = 1}}},
    ["edible|pills"] = 50
  },
  ["tools"] = {
  ...
  ["Ammunation"] = {
    ...
    ["wbody|WEAPON_HATCHET"] = 450
  },
  ["Illegal"] = {
    _config = {map_entity = {"PoI", {blip_id = 156, blip_color = 35, marker_id = 1}}},
    ["wbody|WEAPON_COMBATPISTOL"] = 2500,
    ["wbody|WEAPON_APPISTOL"] = 3500,
	["wbody|WEAPON_REVOLVER"] = 2800,
	
    ["wammo|WEAPON_COMBATPISTOL"] = 2,
    ["wammo|WEAPON_APPISTOL"] = 2,
	["wammo|WEAPON_REVOLVER"] = 2,

    ["wbody|WEAPON_SWITCHBLADE"] = 650,
    ["wbody|WEAPON_KNUCKLE"] = 500
  }
}
...
cfg.shops = {
  ...
  {"food",-705.408996582031,-913.081701660156,19.2155857086182},
  
  {"hidden_explosive",824.353515625,-2152.15625,29.619012832642},
  {"hidden_explosive",1406.5499267578,3667.5219726562,34.032154083252},
  ...
  --]]
  {"Ammunation", 1706.88, 4920.49,42.06},
  {"Ammunation", 21.70, -1107.41, 29.79},
  {"Ammunation", 844.299, -1033.26, 28.1949},
  {"Ammunation", -330.6654663086,6082.9189453125,31.454765319824},
  {"Illegal", 131.79,-1938.502,20.614}
