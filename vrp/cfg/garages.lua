...
cfg.garage_types = {
  ["Garage"]  = {
	...
	["contgt13"] = {"Bentley 2013", 500000, ""},
	["bbentayga"] = {"BentleyBen", 500000, ""},
	["bmm"] = {"BentleyMul", 500000, ""},
	["750li"] = {"BMW 7L", 200000, ""},
	["m4f82"] = {"BMW M4", 500000, ""},
	["myf90"] = {"BMW M5", 500000, ""},
	["x5e53"] = {"BMW M6", 500000, ""},
	["x5e53"] = {"BMW X5", 500000, ""},
	["x6m"] = {"BMW X6", 500000, ""},
	["chiron"] = {"Bugatti Chiron", 500000, ""},
	["bdivo"] = {"Bugatti Divo", 500000, ""},
	["bdivo"] = {"Bugatti Veyron", 500000, ""},
	["gsxb"] = {"Buick 1970", 500000, ""},
	["bgnx"] = {"Buick 1987", 500000, ""},
	["124spider"] = {"Spider", 500000, ""},
	["CYCLONE"] = {"Cyclone", 415000, ""},
    ["blista"] = {"Blista", 15000, ""},
...
--[[
  ...
  ["mechanic"] = {
    _config = {map_entity = {"PoI", {blip_id = 50, blip_color = 56, marker_id = 1}}, permissions = {"repair.vehicle"} },
    ["towtruck"] = {"Large Tow Truck", 2500,""},
	["towtruck2"] = {"Small Tow Truck", 300,""},
  },
  ["police"] = {
    _config = {map_entity = {"PoI", {blip_id = 50, blip_color = 38, marker_id = 1}}, permissions = {"police.vehicle"} },
    ["police"] = {"Basic",0,"Basic model."},
    ["police3"] = {"Classic",0,"Sport model."},
    ["police2"] = {"Furtive",0,"Furtive model."},
	["police4"] = {"Unmarked ",0,"Unmarked model."},
    ["policeb"] = {"Bike",0,"Bike model."},
	["fbi"] = {"Dodge Charger",0,"Dodge Charger model."},
    ["fbi2"] = {"Chevrolet Suburban",0,"Chevrolet Suburban model."},
    ["sheriff2"] = {"Sheriff Cruiser",0,"Sheriff Cruiser model."},
    ["sheriff2"] = {"Sheriff Granger",0,"Sheriff Granger model."},
	["pranger"] = {"Park Ranger Granger",0,"Park Ranger Granger model."},
	["hwaycar"] = {"Crown Victoria",0,"Crown Victoria model."},
	["hwaycar7"] = {"Rotating Lights Crownvic",0,"Rotating Lights Crownvic model."},
	["hwaycar8"] = {"Charger",0,"Charger model."},
	["unmarked3"] = {"Toyota Camry Unmarked",0,"Toyota Camry Unmarked."},
	["unmarked4"] = {"Ford Mustang GT 2016",0,"Ford Mustang GT 2016 model."},
	["unmarked5"] = {"2010 Ford F350",0,"2010 Ford F350."},
	["unmarked6"] = {"CVPI",0,"CVPI model."},
	["polschafter3"] = {"Unmarked Schafter",0,"Unmarked Schafter model."},
	["um1"] = {"Unmarked Tahoe",0,"Tahoe model."},
	["um2"] = {"Unmarked Crownvic",0,"Crownvic model."},
	["um3"] = {"Unmarked Charger",0,"Charger model."},
	["um4"] = {"Unmarked Taurus",0,"Taurus model."},
	["um5"] = {"Unmarked FPIU",0,"FPIU model."},
  },
  ["emergency"] = {
...
-- {garage_type,x,y,z}
cfg.garages = {
  {"Garage",-356.146, -134.69, 39.0097},
  {"Garage",723.013, -1088.92, 22.1829},
  {"Garage",-1145.67, -1991.17, 13.162},
  {"Garage",1174.76, 2645.46, 37.7545},
  {"Garage",112.275, 6619.83, 31.8154},
  {"Garage",-205.789, -1308.02, 31.2916},
  {"taxi",-286.870056152344,-917.948181152344,31.080623626709},
  {"police",454.4,-1017.6,28.4},
  {"police",1864.47941875,3702.91479218,33.4561653132},
  {"police",-470.927154102,6013.73928125,31.34054944},
  {"emergency",286.44311523438,-591.71295166016,43.11030960083},
  ...
  {"mechanic",401.6619567871,-1633.5534667968,29.291931152344},
