...
cfg.db = {
  ...
  database = "rp",   -- name of database
  user = "root",    --  database username
  password = "fivemdb"   -- password of your database
}
...
cfg.log_level = -1 -- maximum verbose level for logs, -1 may disable logs and 1000 may print all logs
