...
local lsc = {
	...
	,["primarymetallic"] = { 
		...
		["primarymatte"] = { 
			...
			["primarymetal"] = { 
				...
				buttons = { 
					...
					{name = "Brushed Aluminum",colorindex = 119,costs = 9000, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Pure Gold",colorindex = 158,costs = 60000, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Brushed Gold",colorindex = 159,costs = 63000, description = "", centre = 0, font = 0, scale = 0.4}
				}
			}
			,
			["secondarymetal"] = { 
		...
		["primarychrome"] = { 
			...
			buttons = { 
				{name = "Chrome", costs = 35000, colorindex = 120, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["secondarychrome"] = { 
			title = "secondary colors", 
		...
		["transmission"] = { 
			...
			buttons = { 
				...
				{name = "Street Transmission",mod = false,modtype =13, costs = 22000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sports Transmission",mod = 1,modtype =13, costs = 180000, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["turbo"] = { 
			...
			buttons = { 
				...
				{name = "Turbo Tuning",mod = true,modtype =18, costs = 1100000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheels"] = { 
			title = "wheels", 
		...
		["neonlayout"] = { 
			...
			buttons = { 
				...
				{name = "Front,Back and Sides", costs = 2000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["neoncolor"] = { 
			title = "neon color", 
	...
	["armor"] = { 
		...
		buttons = { 
			...
			{name = "Armor Upgrade 40%",modtype = 16, mod = 1, costs = 25000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Armor Upgrade 60%",modtype = 16, mod = 2, costs = 210000, description = "", centre = 0, font = 0, scale = 0.4},
	...
	["brakes"] = { 
		...
		name = "brakes",
		buttons = { 
			{name = "Stock Brakes",modtype = 12, mod = -1, costs = 300, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Street Brakes",modtype = 12, mod = false, costs = 5100, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Race Brakes",modtype = 12, mod = 2, costs = 29000, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["engine"] = { 
		...
		name = "engine",
		buttons = { 
			{name = "EMS Upgrade, Level 1",modtype = 11, mod = -1, costs = 5000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 2",modtype = 11, mod = false, costs = 21000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 140000, description = "", centre = 0, font = 0, scale = 0.4},
...
function UpdateVehicle(car)
	Citizen.CreateThread(function()
		...
		if DoesEntityExist(veh) then
			...
			vRP.EXT.Base._notify("No vehicle found!")
		end
	end)
end
