...
local clothing_shops = {
	...
	{name="Clothing Store", id=73, x=-543.5, y=-203.90, z=38.21},
	{name="Clothing Store", id=73, x=72.31, y=-1398.45, z=29.37}
}
incircle = false
Citizen.CreateThread(function()
    for _, item in pairs(clothing_shops) do
	    if (item.x == -543.5) then 
			goto continue
		end
