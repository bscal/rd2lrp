...
{entering = {-30.026309967042,-1105.0656738282,26.422369003296}, inside = {-75.28823852539,-819.08709716796,326.17541503906}, outside = {-29.130708694458,-1081.6518554688,26.638877868652}, pickup = nil},
}
...
function vehSR_CloseCreator(vehicle,veh_type)
	Citizen.CreateThread(function()
		...
		if not boughtcar then
			...
			vRP.EXT.Base.teleport(-39.77363204956,-1110.4862060546,26.438457489014)
            ...
            TriggerServerEvent("vrp_buyVehicle", vehicle, 0)
            TriggerServerEvent("vrp_spawnVehicle", vehicle)
							...
							if IsControlJustPressed(1,23) then
								if(testDriveCar == nil)then
									...
									if HasModelLoaded(hash) then
										...
										vRP.EXT.Base:notify("~g~You have ~r~1 Minute~g~ to test drive this vehicle!")
										for i = 0,24 do
